...
def search_users_view(request, *args, **kwargs):
    if request.method == 'GET':
        ...
        if parameter_search_string:
            ...
            parameter_search_string_users_ordered = parameter_search_string_users.order_by('username')
            if parameter_search_string_users_ordered:
                empty_result = False

                for parameter_search_string_user in parameter_search_string_users_ordered:
